...
public class SpoQuestionActivity extends AppCompatActivity {
    TextView tv;
    ...
    String questions[] = {
            "Which country was host Cricket World Cup 2019 ?" ,
            "Who won the Cricket World Cup in 2008 ?",
    ...
    String answers[] = {"England","India","Homepage","Control Unit","Java","MHz","Internet","Douglas Englebert","both b and c","Silicon",};
    String opt[] = {
            "India","Australia ","England","None of these",
...
//                Toast.makeText(getApplicationContext(), ansText, Toast.LENGTH_SHORT).show();
                ...
                {
                    marks=correct;
                    Intent in = new Intent(getApplicationContext(),SpoResultActivity.class);
                    startActivity(in);
                }
                radio_g.clearCheck();
            }
        ...
        quitbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),SpoResultActivity.class);
