...
public class GeoQuestionActivity extends AppCompatActivity {
    TextView tv;
...
//                Toast.makeText(getApplicationContext(), ansText, Toast.LENGTH_SHORT).show();
                ...
                {
                    marks=correct;
                    Intent in = new Intent(getApplicationContext(),GeoResultActivity.class);
                    startActivity(in);
                }
                radio_g.clearCheck();
            }
        ...
        quitbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),GeoResultActivity.class);
